...
subroutine SwanGSECorr ( rhs, cgo, spcdir, idcmin, idcmax, isslow, isstop, trac0)
!
!   --|-----------------------------------------------------------|--
...
!
    ...
    !
    real(rkind)                                  :: area0    ! area of present cell
    real(rkind)                                  :: area1    ! area of next cell
    real(dkind)                                  :: carea    ! twices the area of centroid dual around present vertex
    real(rkind)                                  :: cslat    ! cosine of latitude
    real(rkind)                                  :: dac2dx   ! x-derivative of action density
    real(rkind)                                  :: dac2dy   ! y-derivative of action density
    real(rkind)                                  :: dcg      ! group velocity difference across frequency bin
    real(rkind)                                  :: dgx0     ! x-component of diffusion gradient inside present cell
    real(rkind)                                  :: dgx1     ! x-component of diffusion gradient inside next cell
    real(rkind)                                  :: dgxdx    ! x-gradient of x-diffusion gradient component
    real(rkind)                                  :: dgy0     ! y-component of diffusion gradient inside present cell
    real(rkind)                                  :: dgy1     ! y-component of diffusion gradient inside next cell
    real(rkind)                                  :: dgydy    ! y-gradient of y-diffusion gradient component
    real(rkind)                                  :: dnn      ! waveage-dependent diffusion coefficient normal to propagation direction
    real(rkind)                                  :: dss      ! waveage-dependent diffusion coefficient in propagation direction
    real(rkind)                                  :: dxx      ! xx-component of diffusion coefficient in Cartesian coordinates
    real(rkind)                                  :: dxy      ! xy-component of diffusion coefficient in Cartesian coordinates
    real(rkind)                                  :: dyy      ! yy-component of diffusion coefficient in Cartesian coordinates
