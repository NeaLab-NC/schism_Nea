...
!
    ...
    !
    real(rkind)          :: caxloc   ! local wave transport velocity in x-direction at present vertex
    real(rkind)          :: cayloc   ! local wave transport velocity in y-direction at present vertex
    !
