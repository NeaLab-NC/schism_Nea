...
!   Argument variables
!
    real(rkind), dimension(MDC,MSC,ICMAX), intent(out) :: cax  ! wave transport velocity in x-direction
    real(rkind), dimension(MDC,MSC,ICMAX), intent(out) :: cay  ! wave transport velocity in y-direction
