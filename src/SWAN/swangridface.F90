...
!
    ...
    !
    real(rkind)                                  :: carea1    ! area of cell 1 adjacent to present face
    real(rkind)                                  :: carea2    ! area of cell 2 adjacent to present face
    real(rkind)                                  :: lengthf   ! length of present face
    real(rkind)                                  :: xdiff     ! difference in x-coordinate between vertex 2 and vertex 1
    real(rkind)                                  :: ydiff     ! difference in y-coordinate between vertex 2 and vertex 1
    !
