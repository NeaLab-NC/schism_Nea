...
!    read initialisation file
     IF(myrank.eq.0) PRINT *,'read initialisation file ',INIFIL
!
...
!
920 INERR=920                                                           
   IF (myrank.EQ.0) WRITE(*,*) 'Cannot open PRINT file '     
   RETURN                                                             
!
...
!
930 INERR=930                                                           
   IF(myrank.EQ.0) WRITE(*,*) 'Error reading initialisation file '  
   RETURN                                                              
!
935 INERR=935                                                           
   IF(myrank.EQ.0) WRITE(*,*) 'Incorrect version of initialisation file '
   RETURN                                                              
!
950 INERR=950                                                           
   IF(myrank.EQ.0) WRITE(*,*) 'Error opening initialisation file ' 
   RETURN                                                              
!
