...
!
    ...
    !
    real(rkind)                                       :: asort          ! ordering of vertices along a user-given direction
    real(rkind)                                       :: maxgsiz        ! maximum gridsize
    real(rkind)                                       :: mingsiz        ! minimum gridsize
    !
    real(rkind), dimension(:), save, allocatable      :: xcugrd         ! the x-coordinates of the grid vertices
    real(rkind), dimension(:), save, allocatable      :: xcugrdgl       ! the x-coordinates of the grid vertices in global grid
    real(rkind), dimension(:), save, allocatable      :: ycugrd         ! the y-coordinates of the grid vertices
    real(rkind), dimension(:), save, allocatable      :: ycugrdgl       ! the y-coordinates of the grid vertices in global grid
!
!   Source text
!
